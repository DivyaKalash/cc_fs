...
#                 pfc = line[5]
#                 sf6 = line[6]
#                 alloted_credit = line[7]
#                 calculated_credit = line[8]
#                 credit_used = line[9]
#                 available_credit = line[10]
#                 date = line[11]
#                 temp = {"org_id": org_idd,"co2":co2,"ch4": ch4, "n2o": n2o, "hfc": hfc, "pfc": pfc, "sf6": sf6,"alloted_credit":alloted_credit,"calculated_credit": calculated_credit,"credit_used":credit_used,"available_credit": available_credit ,"date": date}
#                 org_trans.append(temp)
#             elif(org_idd == "undefined\n"):
#                 break
#         return org_trans
#
#
...
class BlockVote:
    ...
    #         # print(x)
    #         # print(((x%10) + i*i)%100)
    #         # print(type(lines[((x%10) + i*i)%100]))
    #         if(lines[((x%10) + i*i)%100] == "undefined\n"):
    #             print(((x%10) + i*i)%100)
    #             return (((x%10) + i*i)%100)
    ...
    #     # lines = [None]*100;
    #     b = org_id+"|"+co2+"|"+ch4+"|"+n2o+"|"+hfc+"|"+pfc+"|"+sf6+"|"+str(self.credit)+"|"+str(self.calculated_credit)+"|"+str(self.credit_used)+"|"+str(self.credit-self.credit_used)+"|"+date+"|\n"
    #     # lines[index] = b
    #     with open("org.txt", "r") as file:
    #         lines = file.readlines()
    #     print(index)
